...
int CTranslator::Translate(CBroadcastPacket& oPktSrc)
{
	try
	{
        ...
        */
		...
		BOOL  bGetClosePrice = false;
        if (m_dataFilter.isFilter(stNow.wYear, stNow.wMonth, stNow.wDay, 
            stNow.wDayOfWeek, stNow.wHour, stNow.wMinute))
        {
			//added by kenny 2014-1-24  15:40:00到15::50:00之间的数据不在此处过滤
			if (stNow.wHour == 15 && stNow.wMinute < 50 && stNow.wMinute >40)
			{
				bGetClosePrice = true;
				CRLog(E_APPINFO,"开始接收盘后的收盘价格！");
			}
			else
			{
        ...
        */
		...
		if (it != m_mapQuotation.end())
		{
			...
			//added by kenny 2014-1-24
			if(bGetClosePrice /*&& !bTradeTime*/)
			{
				if (stQuotation.m_uiClose >0)
				{
					map<std::string, QUOTATION>::iterator it = m_mapQuotation.find(sInstID);
					(*it).second.m_uiClose = stQuotation.m_uiClose;
					(*it).second.m_uiLast  = stQuotation.m_uiClose;
					if (0 != m_pDataSrcCpMgr )
					{
						m_pDataSrcCpMgr->ToXQueue(stQuotation);
					}

					CRLog(E_APPINFO,"盘后的收盘价格接收成功！");
					
					return 0;
				}
				else
				{
					CRLog(E_APPINFO,"盘后数据二次过滤抛弃！");
					return  -1;
				}
...
int CTranslator::TranslateZipPacket(CBroadcastPacket& oPktSrc, QUOTATION& stQuotation)
{
	...
	while (nIdx < nLen && nRtn != -1)
	{
		...
		//	{
		//	    sFldQuo += "Bid6p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[5].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid6v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[5].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid7p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[6].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid7v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[6].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid8p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[7].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid8v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[7].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid9p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[8].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid9v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[8].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid10p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[9].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Bid10v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Bid[9].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask6p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[5].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask6v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[5].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask7p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[6].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask7v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[6].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask8p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[7].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask8v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[7].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask9p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[8].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask9v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[8].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask10p(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[9].m_uiPrice);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/10);
		//		sFldQuo += ")|";
		//	}
		...
		//	{
		//	    sFldQuo += "Ask10v(";
		//		sFldQuo += ToString<unsigned int>(stQuotation.m_Ask[9].m_uiVol);
		//		sFldQuo += "-";
		//		sFldQuo += ToString<unsigned int>(uiValue/1000);
		//		sFldQuo += ")|";
		//	}
	...
	//盘中发现close为0 ，不知道客户端报价取得是last还是close
	if(stQuotation.m_uiClose <= 0)
	{
		stQuotation.m_uiClose = stQuotation.m_uiLast;
	}
