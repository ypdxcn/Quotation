...
{	
	...
	{0,    EnumKeyTranslator,			EnumKeyIfYC,     "DzhMarketQuote"},
	{0,    EnumKeyTranslator,			EnumKeyIfYC,     "quoteAnalyseTick"},
	{0,    EnumKeyTranslator,			EnumKeyIfYC,     "UpMarketQuote"},//kenny 2014-4-30增加测试接口
	{0,    EnumKeyTranslator,			EnumKeyIfYC,     "onRecvDeferQuotation"},
...
int CDataSrcCpMgr::Init(const string& sProcName)
{
	...
	sCfgFilename = sCfgFilename + "DataSrc_nymex";//m_sProcName;
